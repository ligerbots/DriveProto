...
public class RobotMap {
    ...
    public static void init() {
        ...
        try { 
            driveTrainRightFrontDrive = new CANJaguar(8);
        } catch (CANTimeoutException ex) {
            ex.printStackTrace();
        }
	...
	LiveWindow.addSensor("EncoderTester", "QuadratureEncoder1", encoderTesterQuadratureEncoder1);
        encoderTesterQuadratureEncoder1.setDistancePerPulse(0.03490658503);
        encoderTesterQuadratureEncoder1.setPIDSourceParameter(PIDSourceParameter.kRate);
